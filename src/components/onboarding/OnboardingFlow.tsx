      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-24">
        <div className="max-w-4xl w-full text-center space-y-12">
          <div className="space-y-6">
            <h1 className="text-5xl md:text-7xl font-bold font-heading text-[var(--color-primary)] leading-tight tracking-tight">
              {heading}
            </h1>
            <p className="text-xl md:text-2xl font-body text-[var(--color-secondary)] max-w-2xl mx-auto leading-relaxed">
              {subheading}
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <button
              type="button"
              onClick={onStart}
              className="group relative overflow-hidden px-10 py-5 rounded-[8px] bg-[var(--color-primary)] text-white text-xl font-bold shadow-[var(--shadow-sm)] transition-all duration-200 ease-out hover:shadow-2xl hover:shadow-[var(--color-primary)]/20 active:scale-[0.98]"
            >
...
function TrustSignalCard({ signal }: { signal: TrustSignal }) {
  return (
    <div className="bg-[var(--color-surface-high)] rounded-[12px] p-8 flex flex-col items-center text-center space-y-4 transition-transform duration-300 hover:-translate-y-1">
      ...
      <h3 className="text-lg font-bold font-heading text-[var(--color-primary)]">
        {signal.title}
      </h3>
      <p className="text-sm font-body text-[var(--color-secondary)]">
        {signal.description}
      </p>
    </div>
  );
